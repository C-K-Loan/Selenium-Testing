...
public class OneProductLoaded extends BaseCBTTestCase {
  ...
  @Test
  public void testOneProductLoaded() throws Exception {
                           // we wrap the test in a try catch loop so we can log assert failures in
                           // our system
                           try {    String productListCounter = driver.findElement(By.xpath("//*[@id=\"product-ul\"]/li[1]")).getAttribute("data-product-list-counter");
    String productListCount = driver.findElement(By.xpath("//*[@id=\"product-ul\"]/li[1]")).getAttribute("data-product-list-count");
    String data-clickcat = driver.findElement(By.xpath("//*[@id=\"product-ul\"]/li[1]/div/a")).getAttribute("data-clickcat");
    String dataAdvertiser = driver.findElement(By.xpath("//*[@id=\"product-ul\"]/li[1]/div/a")).getAttribute("data-advertiser");
    System.out.println(dataAdvertiser);
    System.out.println(data-clickcat);
    System.out.println(productListCount);
    System.out.println(productListCounter);
